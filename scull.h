...
#ifdef SCULL_DEBUG
#	ifdef __KERNEL__
		/* If debugging is on, and in kernel space */
...
#undef PDEBUGG
#define PDEBUGG(fmt, args...)	/* nothing: what's this for? */
...
#define SCULL_NR_DEVS 4		/* scull0 through to scull3 */
#endif
 ...
 * G means "Get": reply by setting through pointer
...
/*
 * The other entities only have "Tell" and "Query", because they're not
 * printed in the book, and there's no need to have all six.
 */
